...
> generated manifest flags are ignored: opens are not tracked (the `MainActivity` code generation that
> used to do this was removed in v1.0.0), and setting either prop to `false` does not opt you out.

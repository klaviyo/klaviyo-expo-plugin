...
export const validateIosConfig = (config: KlaviyoPluginProps['ios']) => {
  ...
  // Validate notificationServiceExtensionEnabled
  if (config.notificationServiceExtensionEnabled !== undefined && typeof config.notificationServiceExtensionEnabled !== 'boolean') {
    throw new KlaviyoConfigError('iOS notificationServiceExtensionEnabled must be a boolean');
  }
};
